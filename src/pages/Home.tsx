  ...
  return (
    <div>
      ...
      <header className="min-h-screen flex flex-col items-center justify-center bg-gray-50 py-16 px-4">
        ...
        {/* Headline */}
        <h1 className="text-4xl md:text-5xl font-extrabold text-[#111827] mb-4 text-center">
          Find the Perfect <br></br>
          <span className="bg-[#2265A2] from-sky-400 bg-clip-text text-transparent">
            Freelance Services
          </span>{" "}
          <br></br>
          For your Business
        ...
        <p className="text-gray-600 text-lg md:text-xl max-w-2xl text-center mb-8">
          Work with talented freelancers from around the world. Post your
          project and get competitive proposals within minutes.
        </p>
        ...
        <form className="w-full lg:max-w-3xl mx-auto px-10">
          ...
          <div className="relative">
            ...
            <input
              type="search"
              id="search"
              className="block w-full p-4 pl-12 bg-white border border-gray-200 text-gray-900 text-base rounded-xl focus:ring-2 focus:ring-gray-800 focus:border-gray-800 shadow-sm placeholder:text-gray-500"
              placeholder="Try 'logo design' or 'web development'"
              required
            />
            <button
              type="button"
              className="absolute right-2 bottom-2.5 text-white bg-[#2265A2] hover:bg-[#0F2854] focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-6 py-2 focus:outline-none flex items-center gap-2"
            >
              Search <span>→</span>
            </button>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-12">
              ...
              <div className="flex flex-wrap justify-center gap-3">
                <button className="px-4 py-2 bg-white border border-gray-200 rounded-full text-gray-700 text-sm hover:border-gray-300 transition">
                  Website Design
                </button>
                <button className="px-4 py-2 bg-white border border-gray-200 rounded-full text-gray-700 text-sm hover:border-gray-300 transition">
                  Logo Design
      ...
      <section className="bg-white py-20 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-gray-600 text-center text-lg max-w-2xl mx-auto mb-12">
            Get work done in over 8 different categories
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white p-8 rounded-2xl hover:shadow-lg transition text-center">
              <div className="relative mb-6 flex justify-center">
                ...
                <span className="absolute -top-2 -right-2 w-8 h-8 bg-white border-2 border-gray-200 rounded-full flex items-center justify-center font-bold text-gray-900">
                  1
                </span>
              </div>
              ...
              <p className="text-gray-600 text-sm">
                Describe your project needs and budget. Get matched with
            ...
            <div className="bg-white p-8 rounded-2xl hover:shadow-lg transition text-center">
              ...
              <p className="text-gray-600 text-sm">
                Receive proposals from talented freelancers. Compare profiles,
                portfolios, and rates.
              </p>
            </div>
            ...
            <div className="bg-white p-8  hover:shadow-lg transition text-center">
              ...
              <p className="text-gray-600 text-sm">
                Choose the perfect freelancer and start working together with
                built-in tools.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl hover:shadow-lg transition text-center">
              ...
              <p className="text-gray-600 text-sm">
                Release payments safely with our escrow system. Rate and review
                when complete.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 p-8 rounded-xl">
              ...
              <p className="text-gray-700 text-sm mb-6">
                "The level of talent on this platform made hiring so easy and
                secure for our startup."
              </p>
            ...
            <div className="bg-gray-50 p-8 rounded-xl">
              ...
              <p className="text-gray-700 text-sm mb-6">
                "We've found amazing designers through this platform for listing
                quality clients consistently."
              </p>
              <div className="flex items-center gap-4">
            ...
            <div className="bg-gray-50 p-8 rounded-xl">
              ...
              <p className="text-gray-700 text-sm mb-6">
                "Using this we managed the projects with multiple freelancers
                monthly. Absolutely key to success."
              </p>
              <div className="flex items-center gap-4">
      ...
      <section className="bg-slate-900 py-24 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-300 text-lg mb-12">
            Join thousands of professionals growing their business today
          </p>
