  ...
  return (
    <div className="min-h-screen bg-[#0F2854] flex items-center justify-center px-4">
      ...
      <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch">
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-10 order-1 lg:order-2 form-animate h-full flex flex-col justify-center">
          ...
          <p className="text-center text-gray-600 text-sm mt-6">
            ...
            <button
              ...
              className="text-[#498BC9] hover:text-blue-700 font-bold bg-none border-none cursor-pointer"
            >
              Sign Up
            </button>
          </p>
